...
{
public:
	void Create(newuiMenu *menu, newuiMenuOptionButton *last, short id, const char *name, short x, short y, bool m_mono_press);
...
// set master sheet,button locations
	void SetPlacements(int x, int y, int options_x, int options_y, int options_w, int options_h, 
		int title_x, int title_y, tAlignment align=NEWUI_ALIGN_VERT);
