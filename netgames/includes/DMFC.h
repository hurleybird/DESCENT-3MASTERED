...
#include <signal.h>
    ...
    #else
    	#define DEBUG_BREAK() do{ if(DLLDebugBreak_callback_stop) DLLDebugBreak_callback_stop(); raise(SIGTRAP); if(DLLDebugBreak_callback_resume) DLLDebugBreak_callback_resume(); }while(0)
    #endif
