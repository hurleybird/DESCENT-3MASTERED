...
void DMFCBase::Set_OnServerPlayerExploded(void (*callback)(int player_num))
{
	UserOnServerPlayerExploded = callback;
}

void DMFCBase::Set_OnServerCollide(void (*callback)(object *me_obj,object *it_obj))
{
	UserOnServerCollide = callback;
}
...
void DMFCBase::Set_OnServerGameCreated(void (*callback)(void))
{
	UserOnServerGameCreated = callback;
}

void DMFCBase::Set_OnServerLevelChange(void (*callback)(void))
{
	UserOnServerLevelChange = callback;
}

void DMFCBase::Set_OnServerLevelStart(void (*callback)(void))
{
	UserOnServerLevelStart = callback;
}

void DMFCBase::Set_OnServerLevelEnd(void (*callback)(void))
{
	UserOnServerLevelEnd = callback;
}
...
void DMFCBase::Set_OnServerWallCollide(void (*callback)(object *obj,float hitspeed,int hitseg,int hitwall,vector * hitpt,vector *wall_normal,float hit_dot))
{
...
void DMFCBase::Set_OnServerObjectDestroyed(void (*callback)(object *obj))
{
	UserOnServerObjectDestroyed = callback;
}
...
void DMFCBase::Set_OnClientPlayerExploded(void (*callback)(int player_num))
{
	UserOnClientPlayerExploded = callback;
}

void DMFCBase::Set_OnClientCollide(void (*callback)(object *me_obj,object *it_obj))
{
	UserOnClientCollide = callback;
}
...
void DMFCBase::Set_OnMeDisconnectFromServer(void (*callback)(void))
{
	UserOnMeDisconnectFromServer = callback;
}

void DMFCBase::Set_OnClientGameCreated(void (*callback)(void))
{
	UserOnClientGameCreated = callback;
}
...
void DMFCBase::Set_OnClientLevelChange(void (*callback)(void))
{
	UserOnClientLevelChange = callback;
}

void DMFCBase::Set_OnClientLevelStart(void (*callback)(void))
{
	UserOnClientLevelStart = callback;
}

void DMFCBase::Set_OnClientLevelEnd(void (*callback)(void))
{
	UserOnClientLevelEnd = callback;
}

void DMFCBase::Set_OnClientWallCollide(void (*callback)(object *obj,float hitspeed,int hitseg,int hitwall,vector * hitpt,vector *wall_normal,float hit_dot))
{
...
void DMFCBase::Set_OnClientObjectDestroyed(void (*callback)(object *obj))
{
	UserOnClientObjectDestroyed = callback;
}
...
void DMFCBase::Set_OnPlayerExitsObserver(void (*callback)(int pnum))
{
	UserOnPlayerExitsObserver = callback;
}

void DMFCBase::Set_OnCanChangeTeam(bool (*callback)(int pnum,int newteam))
{
	UserOnCanChangeTeam = callback;
}

void DMFCBase::Set_OnSpecialPacket(void (*callback)(void))
{
	UserOnSpecialPacket = callback;
}

void DMFCBase::Set_OnInterval(void (*callback)(void))
{
	UserOnInterval = callback;
}

void DMFCBase::Set_OnHUDInterval(void (*callback)(void))
{
	UserOnHUDInterval = callback;
}

void DMFCBase::Set_OnPLRInterval(void (*callback)(void))
{
	UserOnPLRInterval = callback;
}

void DMFCBase::Set_OnPLRInit(void (*callback)(void))
{
	UserOnPLRInit = callback;
}

void DMFCBase::Set_OnKeypress(void (*callback)(int key))
{
	UserOnKeypress = callback;
}

void DMFCBase::Set_OnInputString(void (*callback)(char *input_string))
{
	UserOnInputString = callback;
}

void DMFCBase::Set_OnPlayerChangeTeam(void (*callback)(int player_num,int newteam,bool announce,bool spew_everything))
{
	UserOnPlayerChangeTeam = callback;
}

void DMFCBase::Set_OnGameStateRequest(void (*callback)(int pnum))
{
	UserOnGameStateRequest = callback;
}

void DMFCBase::Set_OnSaveStatsToFile(void (*callback)(void))
{
	UserOnSaveStatsToFile = callback;
}

void DMFCBase::Set_OnPlayerReconnect(void (*callback)(int player_num))
{
	UserOnPlayerReconnect = callback;	
}

void DMFCBase::Set_OnPlayerConnect(void (*callback)(int player_num))
{
	UserOnPlayerConnect = callback;
}

void DMFCBase::Set_OnControlMessage(void (*callback)(ubyte msg,int from_pnum))
{
	UserOnControlMessage = callback;
}
...
void DMFCBase::Set_OnClientShowUI(void (*callback)(int id,void *user_data))
{
	UserOnClientShowUI = callback;
}

void DMFCBase::Set_OnPrintScores(void (*callback)(int level))
{
	UserOnPrintScores = callback;
}

void DMFCBase::Set_OnDisconnectSaveStatsToFile(void (*callback)(void))
{
	UserOnDisconnectSaveStatsToFile = callback;
}

void DMFCBase::Set_OnLevelEndSaveStatsToFile(void (*callback)(void))
{
	UserOnLevelEndSaveStatsToFile = callback;
}
...
void DMFCBase::Set_OnDoControls(void (*callback)(game_controls *controls))
{
	UserOnDoControls = callback;
}

void DMFCBase::Set_OnPlayAudioTaunt(void (*callback)(int pnum))
{
	UserOnPlayAudioTaunt = callback;
}
...
void DMFCBase::CallOnServerWallCollide(object *obj,float hitspeed,int hitseg,int hitwall,vector * hitpt,vector *wall_normal,float hit_dot)
{
...
void DMFCBase::CallOnClientWallCollide(object *obj,float hitspeed,int hitseg,int hitwall,vector * hitpt,vector *wall_normal,float hit_dot)
{
...
void DMFCBase::TranslateEvent(int eventnum,dllinfo *data)
{
	...
	case EVT_GAMEWALLCOLLIDE:
		{
			CallOnServerWallCollide(me_objp,data->collide_info.hitspeed,data->collide_info.hitseg,data->collide_info.hitwall,&data->collide_info.point,&data->collide_info.normal,data->collide_info.hit_dot);
		}break;

	case EVT_CLIENT_GAMEWALLCOLLIDE:
		{
			CallOnClientWallCollide(me_objp,data->collide_info.hitspeed,data->collide_info.hitseg,data->collide_info.hitwall,&data->collide_info.point,&data->collide_info.normal,data->collide_info.hit_dot);
		}break;
