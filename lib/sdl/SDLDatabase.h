...
class oeSDLAppDatabase : public oeAppDatabase
{

protected:
	SDLRegistry* database;
public:
	oeSDLAppDatabase();
	oeSDLAppDatabase(oeSDLAppDatabase* parent);
	virtual ~oeSDLAppDatabase();
	SDLRegistry* GetSystemRegistry();
