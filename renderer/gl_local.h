...
class GL3Renderer : public IRenderer
{
	...
	//INIT
	renderer_preferred_state OpenGL_preferred_state = { false, true, false, 32, 1.0, 0, 0, 0, 0, 0, false, 1, 0, false, false, 0.75f, 0.75f, 0.75f, false, true, HBAO_QUALITY_HIGH, HBAO_DEFAULT_SAMPLES, HBAO_NOISE_REFERENCE, HBAO_RESOLUTION_HALF, HBAO_BLUR_WIDE, 3.0f, 1.25f, 0.2f };
