...
void GLCompatibilityRenderer::InitImages(void)
{
...
void GLCompatibilityRenderer::FreeImages(void)
{
...
int GLCompatibilityRenderer::MakeTextureObject(int tn)
{
...
int GLCompatibilityRenderer::MakeBitmapCurrent(int handle, int map_type, int tn)
{
	int w, h;
	int texnum;
...
void GLCompatibilityRenderer::MakeWrapTypeCurrent(int handle, int map_type, int tn)
{
	int uwrap;
	wrap_type dest_wrap;
...
void GLCompatibilityRenderer::MakeFilterTypeCurrent(int handle, int map_type, int tn)
{
	int magf, mmip;
...
void GLCompatibilityRenderer::FreeCache()
{
...
void GLCompatibilityRenderer::ResetCache()
{
	if (OpenGL_cache_initted)
	{
		mem_free(OpenGL_lightmap_remap);
...
void GLCompatibilityRenderer::FreeUploadBuffers()
{
...
void GLCompatibilityRenderer::SetUploadBufferSize(int width, int height)
{
...
void GLCompatibilityRenderer::TranslateBitmapToOpenGL(int texnum, int bm_handle, int map_type, int replace, int tn)
{
	ushort* bm_ptr;
...
void GLCompatibilityRenderer::CopyBitmapToFramebuffer(int bm_handle, int x, int y)
{
...
void GLCompatibilityRenderer::SetFrameBufferCopyState(bool state)
{
	if (state)
	{
...
void GLCompatibilityRenderer::ClearBoundTextures()
{
